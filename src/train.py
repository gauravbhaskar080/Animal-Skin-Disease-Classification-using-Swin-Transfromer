...
torch.backends.cudnn.benchmark = True          # Enables faster training by optimizing cuDNN usage. cuDNN (CUDA Deep Neural Network library) is a GPU-accelerated library developed by NVIDIA that provides optimized primitives for deep learning applications. 
